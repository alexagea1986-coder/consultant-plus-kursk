...
export default function MainContentArea({ anonymousLoggedIn, onAnonymousLogin, selectedProfile }: MainContentAreaProps) {
  ...
  if (!anonymousLoggedIn) {
    return (
      <div className="text-center px-3 sm:px-4 sm:px-6 py-8 bg-white rounded-md border border-[#DDDDDD] min-h-full flex flex-col justify-center">
  ...
  return (
    <div className="flex flex-col h-full bg-white rounded-lg border border-[#DDDDDD] shadow-lg">
      <div className="px-3 sm:px-4 sm:px-6 pt-2 sm:pt-3 flex flex-col flex-1">
        ...
        <div className="flex-1 mb-3 sm:mb-4 overflow-hidden px-3 sm:px-4 sm:px-6">
          {hasChat && (
      ...
      <div 
        className="bg-[#FFD700] py-1.5 rounded-b-lg w-full overflow-hidden shadow-md sm:shadow-lg" 
        onClick={() => textareaRef.current?.focus()}
      >
        <div className="flex w-full border-2 border-[#B8860B] rounded-xl overflow-hidden bg-white focus-within:border-[#B8860B]/80 focus-within:outline-none focus-within:ring-2 focus-within:ring-[#FFD700]/20 focus-within:shadow-md transition-all">
          <Textarea
            ref={textareaRef}
            value={input}
            onChange={(e) => {
            ...
            className="flex-1 w-full text-base sm:text-[15px] border-0 rounded-none px-4 py-4 text-[#333333] placeholder:text-[#666666]/80 focus:border-0 focus:ring-0 focus:outline-none focus:shadow-none focus-visible:ring-0 focus-visible:shadow-none resize-none min-h-[48px] break-words overflow-wrap-break-word"
            disabled={isLoading}
          ...
          <Button 
            ...
            className="flex-shrink-0 bg-white border-l-0 rounded-r-xl px-5 sm:px-6 py-4 min-w-[80px] text-sm sm:text-base focus:outline-none focus:ring-0 focus:border-0 focus:shadow-none focus-visible:ring-0 focus-visible:shadow-none transition-all shadow-sm hover:shadow-md text-[#000000] hover:bg-gray-50 font-semibold"
          >
            Найти
          </Button>
        </div>
