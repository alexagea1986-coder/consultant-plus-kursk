...
ДОПОЛНИТЕЛЬНО: После основного ответа добавь раздел "Возможные уточняющие вопросы:" с 3-5 вариантами вопросов по теме, адаптированными под текущий профиль пользователя. Каждый вопрос — в отдельной строке, нумерованный (1., 2. и т.д.). Эти вопросы должны раскрывать дополнительные аспекты ситуации, помогая углубить консультацию. Для конкретного профиля вопросы должны быть строго под него (например, для юриста — о спорах и нормах).
