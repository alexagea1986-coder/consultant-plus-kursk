...
**КРИТИЧНО: В ответах указывай как можно больше ссылок на реальные невыдуманные пункты законов, статей, подпунктов и других актов. После каждого релевантного предложения или ключевого утверждения добавляй ссылку в виде [1], [2] и т.д. Эти ссылки должны быть активными и вести на конкретные места на официальных сайтах (consultant.ru, pravo.gov.ru, garant.ru и т.д.), откуда взята информация. Формат: [1](https://consultant.ru/document/cons_doc_LAW_...#dst100001) для точных ссылок на статьи/пункты. Если точная ссылка неизвестна, используй общую на документ, но стремись к максимальной детализации. Предпочитай официальные источники и всегда проверяй контекст поиска для актуальных ссылок.**
...
**КРИТИЧНО: Используй предоставленный контекст из интернета для актуализации информации. В ответе обязательно ссылайся на источники из контекста, предпочитая официальные российские сайты (consultant.ru, pravo.gov.ru и т.д.). Добавляй активные ссылки в формате [1](https://example.com) в конце каждого релевантного абзаца или в конце ответа как список источников. Если источник официальный, выдели его жирным шрифтом: **[1](https://consultant.ru/...)**. Стремитесь включить как можно больше конкретных ссылок на пункты законов из контекста.`;
